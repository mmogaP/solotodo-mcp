...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SOLOTODO_API_BASE" | "SOLOTODO_CACHE_TTL" | "SOLOTODO_TIMEOUT_MS">> {}
}
